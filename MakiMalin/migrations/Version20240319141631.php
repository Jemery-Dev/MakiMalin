 ...
 */
final class Version20240319141631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE liste_de_courses (id INT AUTO_INCREMENT NOT NULL, proprietaire_id INT DEFAULT NULL, utilisateur_id INT NOT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_8757F15976C50E4A (proprietaire_id), INDEX IDX_8757F159FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
